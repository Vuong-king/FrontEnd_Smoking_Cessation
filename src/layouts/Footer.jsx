        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-white/70 mb-4 max-w-xs">
              We provide effective smoking cessation solutions that support
              healthier lives and help individuals quit smoking successfully.
            </p>
            <p className="text-white/50 text-sm">
              © {new Date().getFullYear()} EXHELA. All rights reserved.
            </p>
          </div>
