...
const useProgress = (userId = null, stageId = null, planId = null) => {
  ...
  const fetchUserOverallProgress = useCallback(
    async (targetUserId = userId) => {
      ...
      try {
        const data = await ProgressService.getUserOverallProgressAPI(targetUserId);
  ...
  const fetchPlanProgress = useCallback(
    async (targetPlanId = planId) => {
      ...
      try {
        const data = await ProgressService.getSinglePlanProgressAPI(targetPlanId);
  ...
  const fetchPlanTotalStats = useCallback(
    async (targetPlanId = planId) => {
      ...
      try {
        const data = await ProgressService.getTotalMoneySavedInPlanAPI(targetPlanId);
  ...
  const fetchPlanSmokingStats = useCallback(
    async (targetPlanId = planId) => {
      ...
      try {
        const data = await ProgressService.getPlanSmokingStatsAPI(targetPlanId);
  ...
  const fetchStageProgress = useCallback(
    async (targetStageId = stageId, forceRefresh = false) => {
      ...
      try {
        ...
        try {
          const stageStats = await ProgressService.getSingleStageProgressAPI(targetStageId);
  ...
  const createProgressEntry = useCallback(
    async (progressData) => {
      ...
      try {
        ...
        resultEntry = await ProgressService.createProgress(payload);
  ...
  const updateProgressEntry = useCallback(
    async (id, progressData) => {
      ...
      try {
        const updatedEntry = await ProgressService.updateProgress(id, progressData);
        setProgress((prev) =>
