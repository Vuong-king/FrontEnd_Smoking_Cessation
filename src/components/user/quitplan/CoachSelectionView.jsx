...
const CoachSelectionView = ({
  ...
  return (
    <div className="min-h-screen text-slate-800 p-4 max-w-6xl mx-auto">
      ...
      {/* Thông báo nhắc nhở chọn coach */}
      <Alert
        message="Bước đầu tiên: Chọn huấn luyện viên"
        description="Để bắt đầu hành trình cai thuốc, bạn cần chọn một huấn luyện viên phù hợp. Huấn luyện viên sẽ giúp bạn xây dựng kế hoạch cai thuốc cá nhân và hỗ trợ bạn trong suốt quá trình."
        type="info"
        showIcon
        className="mb-6"
      />
