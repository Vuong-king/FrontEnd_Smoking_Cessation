  ...
  >
    ...
    <div className="p-4 flex flex-col flex-1">
      <div className="space-y-3 mb-4">
        <InfoBox label="Kinh nghiệm" value={`${coach.experience_years} năm`} color="green" />
        <InfoBox label="Buổi hỗ trợ" value={coach.total_sessions} color="blue" />
        <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-100 flex justify-between items-center">
          ...
          <div className="flex items-center gap-1">
            <Rate disabled allowHalf defaultValue={coach.rating_avg} style={{ fontSize: "12px" }} />
            <Text className="text-yellow-600 text-xs">({coach.rating_avg})</Text>
          </div>
        </div>
      </div>
